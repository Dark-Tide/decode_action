//Fri Jan 02 2026 23:49:55 GMT+0000 (Coordinated Universal Time)
            ...
            while (true) {
              switch (E[++F]) {
                ...
                case 22:
                  ...
                  break;
                case 23:
                  S = w[E[++F]], k = w[E[++F]], s = Object.getOwnPropertyDescriptor(S, k) || {
                    configurable: true,
                    enumerable: true
                  };
                  s.get = w[E[++F]];
                ...
                case 29:
                  S = [];
                  for (k in w[E[++F]]) S.push(k);
                  w[E[++F]] = S;
                  break;
                case 30:
                  S = w[E[++F]];
                  if (w[E[++F]] = !!S.length) w[E[++F]] = S.shift();else ++F;
                  break;
                case 31:
                  K.push(F + E[++F]);
                  break;
